...
export function BackupPage({ suratMasuk, suratKeluar, onRefresh }: Props) {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-office-text dark:text-slate-100">Backup Data</h2>
        <p className="text-sm text-office-subtext dark:text-slate-400">Cadangkan dan pulihkan data dari server cloud.</p>
      </div>
