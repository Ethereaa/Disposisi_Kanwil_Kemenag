          ...
          {options.map((o) => {
            ...
            return (
              <button
                ...
                className="group flex items-center gap-3 rounded-full bg-white/98 pl-4 pr-2 py-2 text-sm font-medium text-slate-700 shadow-md transition-transform hover:scale-[1.03] dark:bg-slate-800/98 dark:text-slate-100"
              >
                {o.label}
